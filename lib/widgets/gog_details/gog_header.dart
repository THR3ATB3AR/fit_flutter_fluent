...
class _GogHeaderState extends State<GogHeader> {
  ...
  void initState() {
    super.initState();
    // if (widget.gogGame.downloadLinks.isNotEmpty) {
    //   _selectedDownloadMethod = widget.gogGame.downloadLinks.keys.first;
    //   List<Map<String, String>>? mirrors =
    //       widget.gogGame.downloadLinks[_selectedDownloadMethod!];
  ...
  // }
    ...
    //             widget.gogGame.downloadLinks.containsKey(
    //               currentDialogSelectedMethod,
    //             )) {
    //           currentMirrorsForDialog =
    //               widget.gogGame.downloadLinks[currentDialogSelectedMethod]!;
    //         }
    ...
    //                         isExpanded: true,
    //                         items:
    //                             widget.gogGame.downloadLinks.keys
    //                                 .map(
    ...
    //                               List<Map<String, String>>? mirrors =
    //                                   widget.gogGame.downloadLinks[newValue];
    //                               if (mirrors != null && mirrors.isNotEmpty) {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FilledButton(
              ...
              onPressed: () {},
                  // widget.gogGame.downloadLinks.isEmpty
                  //     ? null
                  //     : showDownloadDialog,
              child: Row(
